...
const App = () => {
  ...
  const startPlay = async () => {
    ...
    appStream.onVideoInitialized = () => {
      ...
      // Hide default UI after DOM is mounted (in case it wasn't available earlier)
      ...
      // Also mute the separate audio element the SDK creates
      try {
...
const avatar = createAvatar(personas, {
  ...
  // Keep fullscreen state in sync if user exits via Escape
  React.useEffect(() => {
  ...
  return (
    <div className='containMain'>
      ...
      {/* ================================================================
          LOADING SCREEN with WebRTC progress
          ================================================================ */}
      {isLoading && (
      ...
      {/* ================================================================
          STREAM CONTROLS: Mute, Fullscreen, Info, + custom
          ================================================================ */}
      {!isLoading && (
        <div className="stream-controls">
          ...
          {/* ============================================================
              Add your own control buttons here, for example:

              <button className="control-btn" onClick={() => enableMouseHover()} title="Enable Mouse Hover">...</button>
              <button className="control-btn" onClick={() => handleMicrophone()} title="Mic">...</button>
